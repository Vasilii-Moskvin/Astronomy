...
def get_XMatch_form_Aladin(save_dir_path, ra, de, radius="14'"):
    """
...
def main():
    ...
    try:
        XMatch_from_Aladin_path = get_XMatch_form_Aladin(save_dir_path, ra, de, radius)
        if XMatch_from_Aladin_path:
            convert_XMatch_to_catalogue(XMatch_from_Aladin_path)
    except OSError as e:
        print(e)
